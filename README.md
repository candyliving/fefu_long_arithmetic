...
## 4. Тестирование
Основная цель тестирования - проверка корректности и эффективности операций длинной арифметики. Для проверки использовался язык программирования Python, так как операции длинной арифметики встроены в него по умолчанию.
